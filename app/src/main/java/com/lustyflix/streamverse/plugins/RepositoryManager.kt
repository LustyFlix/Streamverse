...
import com.lustyflix.streamverse.plugins.PluginManager.getPluginSanitizedFileName
import com.lustyflix.streamverse.plugins.PluginManager.unloadPlugin
...
object RepositoryManager {
    ...
    suspend fun parseRepoUrl(url: String): String? {
        ...
        return if (fixedUrl.contains("^https?://".toRegex())) {
            fixedUrl
        } else if (fixedUrl.contains("^(streamverserepo://)|(https://cs\\.repo/\\??)".toRegex())) {
            fixedUrl.replace("^(streamverserepo://)|(https://cs\\.repo/\\??)".toRegex(), "").let {
