...
import com.lustyflix.streamverse.APIHolder.allProviders
import com.lustyflix.streamverse.APIHolder.apis
import com.lustyflix.streamverse.APIHolder.getApiDubstatusSettings
import com.lustyflix.streamverse.APIHolder.initAll
import com.lustyflix.streamverse.APIHolder.updateHasTrailers
...
import com.lustyflix.streamverse.CommonActivity.loadThemes
import com.lustyflix.streamverse.CommonActivity.onColorSelectedEvent
import com.lustyflix.streamverse.CommonActivity.onDialogDismissedEvent
import com.lustyflix.streamverse.CommonActivity.onUserLeaveHint
import com.lustyflix.streamverse.CommonActivity.screenHeight
import com.lustyflix.streamverse.CommonActivity.setActivityInstance
import com.lustyflix.streamverse.CommonActivity.showToast
import com.lustyflix.streamverse.CommonActivity.updateLocale
import com.lustyflix.streamverse.databinding.ActivityMainBinding
import com.lustyflix.streamverse.databinding.ActivityMainTvBinding
import com.lustyflix.streamverse.databinding.BottomResultviewPreviewBinding
...
import com.lustyflix.streamverse.mvvm.observe
import com.lustyflix.streamverse.mvvm.observeNullable
import com.lustyflix.streamverse.network.initClient
import com.lustyflix.streamverse.plugins.PluginManager
import com.lustyflix.streamverse.plugins.PluginManager.loadAllOnlinePlugins
import com.lustyflix.streamverse.plugins.PluginManager.loadSinglePlugin
import com.lustyflix.streamverse.receivers.VideoDownloadRestartReceiver
import com.lustyflix.streamverse.services.SubscriptionWorkManager
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.OAuth2Apis
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.accountManagers
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.appString
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.appStringPlayer
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.appStringRepo
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.appStringResumeWatching
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.appStringSearch
import com.lustyflix.streamverse.syncproviders.AccountManager.Companion.inAppAuths
import com.lustyflix.streamverse.syncproviders.SyncAPI
import com.lustyflix.streamverse.ui.APIRepository
import com.lustyflix.streamverse.ui.SyncWatchType
import com.lustyflix.streamverse.ui.WatchType
import com.lustyflix.streamverse.ui.download.DOWNLOAD_NAVIGATE_TO
import com.lustyflix.streamverse.ui.home.HomeViewModel
import com.lustyflix.streamverse.ui.player.BasicLink
import com.lustyflix.streamverse.ui.player.GeneratorPlayer
import com.lustyflix.streamverse.ui.player.LinkGenerator
import com.lustyflix.streamverse.ui.result.LinearListLayout
import com.lustyflix.streamverse.ui.result.ResultViewModel2
import com.lustyflix.streamverse.ui.result.START_ACTION_RESUME_LATEST
import com.lustyflix.streamverse.ui.result.SyncViewModel
import com.lustyflix.streamverse.ui.result.setImage
import com.lustyflix.streamverse.ui.result.setText
import com.lustyflix.streamverse.ui.result.txt
import com.lustyflix.streamverse.ui.search.SearchFragment
import com.lustyflix.streamverse.ui.search.SearchResultBuilder
...
import com.lustyflix.streamverse.ui.settings.Globals.updateTv
import com.lustyflix.streamverse.ui.settings.SettingsGeneral
import com.lustyflix.streamverse.ui.setup.HAS_DONE_SETUP_KEY
import com.lustyflix.streamverse.ui.setup.SetupFragmentExtensions
import com.lustyflix.streamverse.utils.ApkInstaller
import com.lustyflix.streamverse.utils.AppUtils.html
import com.lustyflix.streamverse.utils.AppUtils.isCastApiAvailable
import com.lustyflix.streamverse.utils.AppUtils.isLtr
import com.lustyflix.streamverse.utils.AppUtils.isNetworkAvailable
import com.lustyflix.streamverse.utils.AppUtils.isRtl
import com.lustyflix.streamverse.utils.AppUtils.loadCache
import com.lustyflix.streamverse.utils.AppUtils.loadRepository
import com.lustyflix.streamverse.utils.AppUtils.loadResult
...
import com.lustyflix.streamverse.utils.BackupUtils.backup
import com.lustyflix.streamverse.utils.BackupUtils.setUpBackup
...
import com.lustyflix.streamverse.utils.DataStore.setKey
import com.lustyflix.streamverse.utils.DataStoreHelper
import com.lustyflix.streamverse.utils.DataStoreHelper.accounts
import com.lustyflix.streamverse.utils.DataStoreHelper.migrateResumeWatching
import com.lustyflix.streamverse.utils.Event
...
import com.lustyflix.streamverse.utils.UIHelper.changeStatusBarState
...
import com.lustyflix.streamverse.utils.UIHelper.getResourceColor
...
import com.lustyflix.streamverse.utils.UIHelper.toPx
import com.lustyflix.streamverse.utils.USER_PROVIDER_API
import com.lustyflix.streamverse.utils.USER_SELECTED_HOMEPAGE_API
            ...
            with(activity) {
                ...
                if (str != null && this != null) {
                    if (str.startsWith("https://cs.repo")) {
                        ...
                        // https://github.com/lustyflix/gradle/blob/master/src/main/kotlin/com/lustyflix/streamverse/gradle/tasks/DeployWithAdbTask.kt#L46
                        if (str == "$appString:") {
...
//        ioSafe {
//            val plugins =
//                RepositoryParser.getRepoPlugins("https://raw.githubusercontent.com/lustyflix/TestPlugin/master/repo.json")
//                    ?: emptyList()
//            plugins.map {
        ...
        val castContext = CastContext.getSharedInstance(applicationContext)
         fun buildMediaQueueItem(video: String): MediaQueueItem {
           // val movieMetadata = MediaMetadata(MediaMetadata.MEDIA_TYPE_PHOTO)
            //movieMetadata.putString(MediaMetadata.KEY_TITLE, "Streamverse")
...
//        }
    ...
    suspend fun checkGithubConnectivity(): Boolean {
        return try {
            app.get(
                "https://raw.githubusercontent.com/lustyflix/.github/master/connectivitycheck",
                timeout = 5
            ).text.trim() == "ok"
        } catch (t: Throwable) {
            false
