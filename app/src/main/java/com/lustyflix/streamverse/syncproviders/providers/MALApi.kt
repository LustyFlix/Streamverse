...
import com.lustyflix.streamverse.ShowStatus
...
import com.lustyflix.streamverse.utils.AppUtils.splitQuery
...
class MALApi(index: Int) : AccountManager(index), SyncAPI {
    ...
    override val key = "5e178db48bd857825734f61a4afbdc82"
