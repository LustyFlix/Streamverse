...
import com.lustyflix.streamverse.syncproviders.InAppAuthAPIManager
...
class OpenSubtitlesApi(index: Int) : InAppAuthAPIManager(index), AbstractSubApi {
    ...
    companion object {
        ...
        const val apiKey = "kobgMnuAfgSp53Xdgb5ctZfztHK5NyEb"
    ...
    private class OpenSubtitleInterceptor : Interceptor {
        /** Required user agent! */
        private val userAgent = "Streamverse v0.1"
