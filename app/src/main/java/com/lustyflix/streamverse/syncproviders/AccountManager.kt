...
import com.lustyflix.streamverse.syncproviders.providers.SubScene
import com.lustyflix.streamverse.syncproviders.providers.*
...
abstract class AccountManager(private val defIndex: Int) : AuthAPI {
    companion object {
        ...
        const val appString = "streamverseapp"
        const val appStringRepo = "streamverserepo"
        const val appStringPlayer = "streamverseplayer"

        // Instantly start the search given a query
        const val appStringSearch = "streamversesearch"

        // Instantly resume watching a show
        const val appStringResumeWatching = "streamversecontinuewatching"
