...
import com.lustyflix.streamverse.MainActivity.Companion.deleteFileOnExit
...
import com.lustyflix.streamverse.ui.subtitles.SaveCaptionStyle
...
import com.lustyflix.streamverse.utils.DrmExtractorLink
import com.lustyflix.streamverse.utils.EpisodeSkip
import com.lustyflix.streamverse.utils.ExtractorLink
import com.lustyflix.streamverse.utils.ExtractorLinkPlayList
import com.lustyflix.streamverse.utils.ExtractorLinkType
...
//            isPlaying,
    ...
    private fun loadExo(
        ...
        val maxVideoHeight = settingsManager.getInt(
            context.getString(if (context.isUsingMobileData()) com.lustyflix.streamverse.R.string.quality_pref_mobile_data_key else com.lustyflix.streamverse.R.string.quality_pref_key),
            Int.MAX_VALUE
        )
                    ...
                    when (playbackState) {
                        ...
                        Player.STATE_ENDED -> {
                            ...
                            if (PreferenceManager.getDefaultSharedPreferences(context)
                                    ?.getBoolean(
                                        context.getString(com.lustyflix.streamverse.R.string.autoplay_next_key),
                                        true
                                    ) == true
                            ) {
                                handleEvent(
